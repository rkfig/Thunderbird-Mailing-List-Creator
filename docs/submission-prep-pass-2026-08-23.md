...
- Current release-facing docs and reviewer-facing docs were updated to match the 2.3.0 feature set.
...
- Artifact: dist/mailing-list-creator-2.3.0.xpi
...
2. Upload dist/mailing-list-creator-2.3.0.xpi to ATN/Mozilla.
3. Execute Windows/macOS smoke checks if those environments are available.

## Submission Recommendation

Repo-side preparation is complete for a 2.3.0 submission package.
